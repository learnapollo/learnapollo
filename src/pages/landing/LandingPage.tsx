    ...
    return (
      <div className={styles.root}>
        ...
        <dl className={styles.contents}>
          <dt>
            <h3>Overview</h3>
              <p>Get a broad overview of the goals and prerequisites for this hands-on tutorial to the Apollo Client and
          ...
          <dt>
            <h3>Tutorial Tracks</h3>
              ...
              Native. The exercises cover different concepts specific to GraphQL or the Apollo Client. Learn about
              GraphQL queries and how to use fragments to encapsulate data requirements. See how single or multiple
              mutations work. Find out about powerful pagination using GraphQL and the Apollo Client.</p>
          </dt>
          <dt>
            <h3>Excursions</h3>

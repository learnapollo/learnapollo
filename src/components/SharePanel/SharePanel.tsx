...
import {update, getStoredState} from '../../utils/statestore'
  ...
  render() {
    ...
    return (
      <div className='flex justify-center'>
        {this.state.display &&
          <div  className={'right-0 mt5 ph3 bg-black-05-opaque ' + (displayMode !== 'small' ? 'fixed' : '')} style={{top: '18vh', maxWidth: (displayMode === 'medium' ? '16rem' : '40rem')}}>
            <h3 className='accent' style={{fontWeight: 400}}>Liked Learn Apollo So far?</h3>
            <p style={{color: 'black', opacity: 0.4}}>Please consider sharing it so that other people can enjoy it too.</p>
